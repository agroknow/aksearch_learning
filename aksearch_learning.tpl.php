...
$root = drupal_get_path('module', 'aksearch_learning')."/default";
$app = drupal_get_path('module', 'aksearch_learning')."/default/app";
$assets = drupal_get_path('module', 'aksearch_learning')."/default/assets";
$config = drupal_get_path('module', 'aksearch_learning')."/default/config";
$css = drupal_get_path('module', 'aksearch_learning')."/default/css";
$finder = drupal_get_path('module', 'aksearch_learning')."/default/finder";
$lib = drupal_get_path('module', 'aksearch_learning')."/default/lib";
$searchurl = url('node/'.variable_get('aksearch_learning_spage'));
?>
<!-- search page -->
...
<?php print $cont['und']['0']['safe_value']; ?>
 ...
 <div id="akListing" ng-app="akListing" ng-controller="mainController" ng-init="init_finder('agrif','publications');"  class="col-xs-12 col-sm-12 col-md-12"  ng-cloak>		<!-- Language
